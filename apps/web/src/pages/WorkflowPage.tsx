...
export function WorkflowPage() {
  const { approved, resetApproval } = useDemoState()
  ...
  const togglePlayback = () => {
    if (visibleCount >= agentSteps.length) restartTimeline(true)
