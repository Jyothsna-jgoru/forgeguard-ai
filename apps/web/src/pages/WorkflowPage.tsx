...
export function WorkflowPage() {
  ...
  const completed = useMemo(() => Math.min(visibleCount, agentSteps.length - 1), [visibleCount])
  ...
  return (
    <div className="page-container">
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-4"><Metric label="Ticket" value={demoTicket.key} /><Metric label="Agent stages" value="6 + gate" /><Metric label="Validation" value="12 passed" tone="teal" /><Metric label="External action" value="Awaiting approval" tone="amber" /></div>
