  ...
  return (
    <div className="min-h-screen overflow-hidden bg-ink text-slate-200">
      ...
      <header className="relative z-20 mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
        ...
        <Link to="/intake" className="button button-secondary">Explore tickets <ArrowRight size={15} /></Link>
      </header>
      ...
      <main>
        <section className="relative z-10 mx-auto grid min-h-[680px] max-w-7xl items-center gap-12 px-5 pb-20 pt-16 lg:grid-cols-[1.03fr_.97fr] lg:px-8 lg:pt-12">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link to="/intake" className="button button-primary">Choose a Demo Ticket <ArrowRight size={16} /></Link>
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-xs text-slate-500">
              <span className="flex items-center gap-2"><Check size={14} className="text-teal-400" /> No sign-in</span><span className="flex items-center gap-2"><Check size={14} className="text-teal-400" /> Ready-made safe scenarios</span><span className="flex items-center gap-2"><Check size={14} className="text-teal-400" /> Optional local-only input</span>
            </div>
          </div>
        ...
        <section className="border-t border-line/60 bg-gradient-to-b from-[#091321] to-ink py-20 text-center"><div className="mx-auto max-w-3xl px-5"><div className="eyebrow mb-4">See the evidence chain</div><h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">Choose a ticket. Explore the governed path.</h2><p className="mx-auto mt-4 max-w-xl leading-7 text-slate-400">Start with a safe ready-made scenario or use sanitized ticket text of your own, inspect every decision, and approve a simulated draft pull request.</p><Link to="/intake" className="button button-primary mt-8">Explore Demo Tickets <ArrowRight size={16} /></Link></div></section>
      </main>
